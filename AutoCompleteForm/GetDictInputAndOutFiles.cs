...
namespace AutoCompleteForm
{
    public class GetDictInputAndOuputFiles
    {
        public static Dictionary<string, string> Action(WorkOrder.WorkOrder workOrder)
        {
            ...
            {
                dictInputAndOuputFilenames = SelectInputAndOutFiles.Action(workOrder, EqTypeFeedingPumps.InfusionPumpNutriciaFlocareInfinityIpmForm, 
                                                EqTypeFeedingPumps.InfusionPumpNutriciaFlocareInfinityAcceptanceForm);
            ...
            {
                dictInputAndOuputFilenames = SelectInputAndOutFiles.Action(workOrder, EqTypeVolumetricInfusionPumps.InfusionPumpPlumAIpmForm, 
                                                EqTypeVolumetricInfusionPumps.InfusionPumpPlumAAcceptanceForm);
            ...
            {
                dictInputAndOuputFilenames = SelectInputAndOutFiles.Action(workOrder, EqTypeVitalSignMonitors.WelchAllynConnexIpmForm, 
                                                EqTypeVitalSignMonitors.WelchAllynConnexAcceptanceForm);
            ...
            {
                dictInputAndOuputFilenames = SelectInputAndOutFiles.Action(workOrder, EqTypeBedsideMonitors.GeCarescapeMonitorIpmForm, 
                                                EqTypeBedsideMonitors.GeCarescapeMonitorAcceptanceForm);
            ...
            {
                //dictInputAndOuputFilenames.Add(string.Empty, string.Empty);
                dictInputAndOuputFilenames = SelectInputAndOutFiles.Action(workOrder, EqTypeECGMachines.PhilipsTC50IpmForm, 
                                                EqTypeECGMachines.PhilipsTC50AcceptanceForm);
            ...
            //26.electronic thermometer
                ...
                || modelName == "303000")
            {
                dictInputAndOuputFilenames = SelectInputAndOutFiles.Action(workOrder, EqTypeElectronicThermometer.ElectronicThermometerIpmForm, 
                                                EqTypeElectronicThermometer.ElectronicThermometerAcceptanceForm);
            ...
            {
                dictInputAndOuputFilenames = SelectInputAndOutFiles.Action(workOrder, EqTypeSequentialCompressionDevices.CovidienAvImpulseIpmForm, 
                                                EqTypeSequentialCompressionDevices.CovidienAvImpulseAcceptanceForm);
            ...
            {
                dictInputAndOuputFilenames = SelectInputAndOutFiles.Action(workOrder, EqTypeGeneralDeviceClass1.GeneralDevicesIpmForm, 
                                                EqTypeGeneralDeviceClass1.GeneralDevicesAcceptanceForm);
